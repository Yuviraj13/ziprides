...
const SideBar = () => {
  ...
  return (
    <div className="relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r brder-borderColor text-sm">
      <div className="group relative">
        <label htmlFor="image">
          <img
            ...
            alt="profile"
            className="w-9 md:w-14 h-9 md:h-14 rounded-full mx-auto"
          />
          <input
            type="file"
            id="image"
